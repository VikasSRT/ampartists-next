    ...
    <div className="max-w-[888px] mx-auto my-[48px] px-[16px] w-full">
      <ul className={styles.list}>
        {artist.map((artist, index) => (
          <Link href={`${ROUTES.artists}/${artist?.id}`} key={artist?.id}>
            <div className="group bg-card overflow-hidden shadow-lg border border-border/50 flex flex-col w-full sm:max-w-[280px] h-[100%] mx-auto">
